...
export function WorkflowSteps() {
  ...
  return (
    <div className="relative w-[625px]">
      {/* Preview Card Overlay - always visible */}
      <div className="absolute top-[-15px] left-4 w-[112px] h-[51px] gap-[10px] rounded-[8px] border border-[#1414141A] p-[8px] bg-[#FAFAFA] z-20 shadow-sm">
        <div className="w-[96px] h-[35px] flex flex-col gap-[4px]">
          {steps.slice(0, 3).map((step) => (
            <div key={step.id} className="flex items-center gap-1">
              <div className={`w-[8px] h-[8px] rounded-[33.33px] border-[0.5px] border-[#14141433] flex items-center justify-center relative ${
              ...
              <span 
                className={`w-[96px] h-[10px] font-[500] text-[8px] leading-[100%] tracking-[-0.09px] ${
                  step.status === "completed" 
              ...
              >
                Step {step.id}: {step.title.substring(0, 12)}...
              </span>
            </div>
          ))}
        </div>
      ...
      {/* Main Container */}
      <div className="w-[625px] rounded-[12px] border-[0.5px] bg-white border-[#1414141A] shadow-[0px_16px_22px_0px_#14141408,0px_2px_4px_0px_#1414140A,0px_0px_0.5px_0.5px_#1414142E,0px_0px_7px_-3px_#FFFFFF_inset]">
        {/* Main Header */}
        <div 
